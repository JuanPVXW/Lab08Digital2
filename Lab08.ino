...
void loop() {
  ...
  {
    //delay(50);
    myFile = SD.open("Tigre.txt");
    ReadImagen();
    Serial.println("Siguiente Elefante");
    bandera = 0;
  }
  if(contador == 2 & bandera == 1)
  {
    //delay(500);
    myFile = SD.open("Elefante.txt");
    ReadImagen();
    Serial.println("Siguiente Monster");
    bandera = 0;
  }
  if(contador == 3 & bandera == 1)
  {
    //delay(500);
    myFile = SD.open("Monster.txt");
    ReadImagen();
    Serial.println("Siguiente Zebra");
    bandera = 0;
  }
  if(contador == 4 & bandera == 1)
  {
    ...
    ReadImagen();
    Serial.println("Siguiente Tigre");
    bandera = 0;
  }
  if(contador == 5)
  {
...
void menu(void)
{
  ...
  Serial.println("Opcion 1: Tigre");
  Serial.println("Opcion 2: Elefante");
  Serial.println("Opcion 3: Monster");
  Serial.println("Opcion 4: Zebra");
}
void LCD_Init(void) {
